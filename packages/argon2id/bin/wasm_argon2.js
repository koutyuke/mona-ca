...
export function hash(password, options) {
    ...
    try {
        ...
        if (!isLikeNone(options)) {
            _assertClass(options, HashOptions);
            ptr1 = options.__destroy_into_raw();
        }
        wasm.hash(retptr, ptr0, len0, ptr1);
...
const HashOptionsFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_hashoptions_free(ptr >>> 0));
/**
*/
export class HashOptions {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        HashOptionsFinalization.unregister(this);
        return ptr;
    }
    ...
    */
    get parallelism() {
        const ret = wasm.__wbg_get_hashoptions_parallelism(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @param {number} arg0
    */
    set parallelism(arg0) {
        wasm.__wbg_set_hashoptions_parallelism(this.__wbg_ptr, arg0);
    }
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('wasm_argon2_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
