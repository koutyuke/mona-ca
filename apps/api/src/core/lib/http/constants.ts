// Cookie
export const SESSION_COOKIE_NAME = "mc_session" as const;
export const PASSWORD_RESET_SESSION_COOKIE_NAME = "mc_password_reset_session" as const;
export const EMAIL_VERIFICATION_SESSION_COOKIE_NAME = "mc_email_verification_session" as const;
export const ACCOUNT_ASSOCIATION_SESSION_COOKIE_NAME = "mc_account_association_session" as const;
