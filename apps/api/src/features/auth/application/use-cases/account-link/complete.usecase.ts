...
import type {
	AccountLinkCompleteUseCaseResult,
	IAccountLinkCompleteUseCase,
} from "../../contracts/account-link/complete.usecase.interface";
...
export class AccountLinkCompleteUseCase implements IAccountLinkCompleteUseCase {
	constructor(
		// repositories
