...
describe("EmailVerificationRepository.deleteByUserId", () => {
	beforeAll(async () => {
	...
	test("should delete data in database", async () => {
		await emailVerificationRepository.deleteByUserId(emailVerificationTableHelper.baseEmailVerification.userId);
