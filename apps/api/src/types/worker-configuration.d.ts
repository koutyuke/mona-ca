/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/types/worker-configuration.d.ts` (hash: f048c7d02af4d1b7db395b9edb1a2550)
// Runtime types generated with workerd@1.20250823.0 2024-04-19 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		EMAIL_VERIFICATION_SESSION_PEPPER: string;
		PASSWORD_RESET_SESSION_PEPPER: string;
		ACCOUNT_ASSOCIATION_SESSION_PEPPER: string;
		SIGNUP_SESSION_PEPPER: string;
