...
export class MethodNotAllowedException extends ResponseException {
	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
	constructor(option?: { name?: string; message?: string; code?: string; additional?: Record<string, any> }) {
		const { name, message, code, additional } = option ?? {};
		super(
...
export class ImATeapotException extends ResponseException {
	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
	constructor(option?: { name?: string; message?: string; code?: string; additional?: Record<string, any> }) {
		const { name, message, code, additional } = option ?? {};
		super(
...
export class TooManyRequestsException extends ResponseException {
	constructor(
...
export class InternalServerErrorException extends ResponseException {
	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
	constructor(option?: { name?: string; message?: string; code?: string; additional?: Record<string, any> }) {
		const { name, message, code, additional } = option ?? {};
		super(
...
export class BadGatewayException extends ResponseException {
	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
	constructor(option?: { name?: string; message?: string; code?: string; additional?: Record<string, any> }) {
		const { name, message, code, additional } = option ?? {};
		super(
...
export class ServiceUnavailableException extends ResponseException {
	// biome-ignore lint/suspicious/noExplicitAny: <explanation>
	constructor(option?: { name?: string; message?: string; code?: string; additional?: Record<string, any> }) {
		const { name, message, code, additional } = option ?? {};
		super(
